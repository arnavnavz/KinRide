    ...
    <div className="flex min-h-[60vh] items-center justify-center p-6">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-lg dark:bg-gray-900">
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link href="/driver/dashboard" className="inline-flex items-center min-h-[44px] px-3 text-sm font-medium text-indigo-600 hover:underline dark:text-indigo-400">
            Go home
          </Link>
        </div>
      </div>
